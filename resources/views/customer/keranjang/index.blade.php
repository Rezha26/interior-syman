        ...
        <div class="max-h bg-yellow-700">
            ...
            <div class="grid" style="display: flex; justify-content:space-between">
                ...
                <div class="container">
                    ...
                    href="/home/barang" type="submit" class=" text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-200 sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-3  ml-40">Mulai Belanja</a>
                </div>
                </div>
                </div>
            </div>
